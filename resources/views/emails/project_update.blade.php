<div style="font-family: Arial, sans-serif; background: #f8fafc; padding: 32px;">
	...
	<div style="font-size: 16px; color: #334155; margin-bottom: 24px;">
		...
		<div style="text-align: center; margin-bottom: 24px;">
			<a href="{{ $url }}" style="display: inline-block; background: #2563eb; color: #fff; padding: 12px 32px; border-radius: 6px; text-decoration: none; font-weight: bold;">View Project</a>
		</div>
